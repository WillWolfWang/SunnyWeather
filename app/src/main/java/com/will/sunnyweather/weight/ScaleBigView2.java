...
public class ScaleBigView2 extends View {
    ...
    public ScaleBigView2(Context context) {
        this(context, null);
    }

    public ScaleBigView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public ScaleBigView2(Context context, AttributeSet attrs, int defStyleAttr) {
